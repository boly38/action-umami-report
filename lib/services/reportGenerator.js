...
import {ensureDirectoryExistence, isSet, isVerbose} from "./util.js";
import fs from "fs";
...
export default class ReportGenerator {
    ...
    static async produceReportData({
                                       ...
                                       outputFilename = null,
                                       reportContent = 'pageviews|events|urls', period = '24h', unit = 'hour'
                                   }) {
        const generator = new ReportGenerator(site, reportContent, period, unit,
            siteStats, sitePageViews, siteEvents, siteMetricsUrl);
