...
declare type TMetricType = "url" | "referrer" | "browser" | "os" | "device" | "country" | "event" | "language";
interface IAuthData {
    token: string;
    user: {
        user_id: number;
...
export default class UmamiAPIClient {
     ...
     */
    getWebsite(): Promise<ITrackedWebsite>;
    /**
     ...
     */
    getWebsite(website_id: number): Promise<ITrackedWebsite>;
    /**
     ...
     * ```
     */
    getWebsiteBy(key: keyof ITrackedWebsite, value: string | number): Promise<ITrackedWebsite>;
    /**
     ...
     */
    resetWebsite(website_id: number): Promise<ITrackedWebsite>;
    /**
     * Delete a website
     * @param website_id The website's ID (not UUID)
     * @see {@link https://github.com/umami-software/umami/blob/master/pages/api/website/[id]/index.js Relevant Umami source code}
     ...
     * @see {@link https://github.com/umami-software/umami/blob/master/pages/api/websites/index.js Relevant Umami source code}
     */
    getEventsByName(website_id: number, options: {
        name: string;
        period?: TTimePeriod;
        unit?: TUnit;
        tz?: string;
     ...
     */
    getAccounts(): Promise<IUserAccount[]>;
    /**
     ...
     */
    getAccount(user_id: number): Promise<IUserAccount>;
    /**
